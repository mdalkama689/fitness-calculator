...
const TabShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful fitness calculator tool, check it out: https://seosaurus.in/tools/fitness-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/fitness-calculator/";
